...
function TicketFilters({ search, onSearchChange, priority, onPriorityChange, status, onStatusChange }) {
        ...
        <div className="tickets-toolbar">
            ...
            <div className="filter-dropdown-wrapper" ref={prioRef}>
                <button
                    ...
                    onClick={() => { setShowPriority(!showPriority); setShowStatus(false); }}
                >
                    Priority
            ...
            <div className="filter-dropdown-wrapper" ref={statRef}>
                <button
                    ...
                    onClick={() => { setShowStatus(!showStatus); setShowPriority(false); }}
                >
                    Status
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="6 9 12 15 18 9" /></svg>
                </button>
